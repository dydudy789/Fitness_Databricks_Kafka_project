...
class Producer():
    ...
    def user_registration(self, set_num): #set_num is the number of the test dataset
    ...
    def _validate_count(self, format, location, expected_count): #function to check if number of records is as expected
    ...
    def validate(self, sets): #use checking function 
        import time
        start = int(time.time())
