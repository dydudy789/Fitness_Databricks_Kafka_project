...
spark.conf.set("spark.sql.shuffle.partitions", sc.defaultParallelism) #set partitions to number of executor cores
spark.conf.set("spark.databricks.delta.optimizeWrite.enabled", True) 
spark.conf.set("spark.databricks.delta.autoCompact.enabled", True)
spark.conf.set("spark.sql.streaming.stateStore.providerClass", "com.databricks.sql.streaming.state.RocksDBStateStoreProvider") #optimise streaming state store read write performance 
